...
Dans le style 2 des rapports, par exemple, on cherche à modifier l'affichage des sections et sous-sections. Dans ce but, on change l'affichage du compteur (action détaillée dans [**04- les compteurs**](https://github.com/Flantier-Noel/preamble-LaTex/blob/main/unscrew/04-%20les%20compteurs.md)). Ensuite on modifie la police et la disposition du titre de la partie, avec les codes suivants :
